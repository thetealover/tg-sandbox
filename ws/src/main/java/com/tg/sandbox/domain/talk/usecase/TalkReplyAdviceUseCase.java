...
import static com.tg.sandbox.adapter.in.bot.common.usecasestrategy.callback.CallbackUseCaseStrategyType.TALK_ADVICE;
...
public class TalkReplyAdviceUseCase implements CallbackUseCaseStrategy {
